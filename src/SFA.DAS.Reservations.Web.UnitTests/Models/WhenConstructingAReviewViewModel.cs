    ...
    public class WhenConstructingAReviewViewModel
    {
        ...
        public void Then_The_Model_Is_Constructed_With_Correct_Route_Names(uint? ukPrn)
        {
            ...
            if (ukPrn == null)
            {
                ...
                Assert.AreEqual(RouteNames.EmployerApprenticeshipTraining, actual.ChangeRouteName);
            }
            else
            {
                ...
                Assert.AreEqual(RouteNames.ProviderApprenticeshipTraining, actual.ChangeRouteName);
            }
