    ...
    public class WhenCallingPostSelectReservation
    {
            ...
            [NoAutoProperties] SelectReservationsController controller)
        {
            ...
            mockUrlHelper
                .Setup(helper => helper.GenerateAddApprenticeUrl(viewModel.SelectedReservationId.Value,
                    ...
                    false, string.Empty, string.Empty, viewModel.JourneyData, viewModel.ApprenticeshipSessionKey, viewModel.BeforeProviderSelected, viewModel.UseIlrData))
            ...
            [NoAutoProperties] SelectReservationsController controller)
        {
            ...
            mockUrlHelper
                .Setup(helper => helper.GenerateAddApprenticeUrl(viewModel.SelectedReservationId.Value,
                    ...
                    true, string.Empty, string.Empty, viewModel.JourneyData, viewModel.ApprenticeshipSessionKey, viewModel.BeforeProviderSelected, viewModel.UseIlrData))
                .Returns(addApprenticeUrl);
            ...
            [NoAutoProperties] SelectReservationsController controller)
        {
            ...
            mockUrlHelper.Setup(x => x.GenerateAddApprenticeUrl(null, routeModel.AccountLegalEntityPublicHashedId, "",
                ...
                viewModel.EncodedPledgeApplicationId, viewModel.JourneyData, viewModel.ApprenticeshipSessionKey, viewModel.BeforeProviderSelected, viewModel.UseIlrData)).Returns("https://addroute");
                ...
                [NoAutoProperties] SelectReservationsController controller)
        {
            ...
            mockUrlHelper.Setup(x => x.GenerateAddApprenticeUrl(null, routeModel.AccountLegalEntityPublicHashedId, "",
                ...
                viewModel.EncodedPledgeApplicationId, viewModel.JourneyData, viewModel.ApprenticeshipSessionKey, viewModel.BeforeProviderSelected, viewModel.UseIlrData)).Returns("https://add-another-route");
